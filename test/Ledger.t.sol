...
contract LedgerTest is Test {
    ...
    function test_terminalSlotsStillResolveAndKeepHistory() public {
        ...
        RefinementLedger.Fact[] memory h = ledger.historyOf(10);
        assertEq(h.length, 3);
    ...
    function test_historyIsGenesisFirstAndInherited() public {
        ...
        RefinementLedger.Fact[] memory h = ledger.historyOf(9);
        assertEq(h.length, 4);
        assertEq(h[0].kind, GENESIS);
        assertEq(h[1].kind, bytes32("STORED"));
        ...
        RefinementLedger.Fact[] memory r = ledger.historyOf(2);
        assertEq(r.length, 2);
    ...
    function test_factsCarryAttribution() public {
        ...
        RefinementLedger.Fact[] memory h = ledger.historyOf(1);
